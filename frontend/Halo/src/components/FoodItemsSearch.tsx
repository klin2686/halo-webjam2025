...
const FoodItemsSearch = ({
  ...
  if (inline) {
    return (
      <div className="flex items-center w-full h-[3.125rem] bg-white/10 border border-white/50 rounded-xl px-[1rem] backdrop-blur-sm outline outline-1 outline-offset-[-0.0625rem] outline-white/50 shadow-xl">
        <input
          type="text"
          placeholder="Search..."
          value={searchTerm}
